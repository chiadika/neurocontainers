...
`/opt/sodiumgridding/23Na_n28_trajectory.h5`,
`/opt/sodiumgridding/23Na_n50_trajectory.h5`, and
`/opt/sodiumgridding/23Na_n72_trajectory.h5`, all using dataset `k`. Aliases
`sodiumn28`, `sodiumn50`, `sodiumn72`, `23Na_n28`, `23Na_n50`, and `23Na_n72`
are also accepted outside the scanner UI.
...
| Bundled trajectory | `trajectoryfile` | choice | `/opt/sodiumgridding/23Na_n72_trajectory.h5` | Use the bundled n72, n50, or n28 trajectory when the MRD input has no embedded trajectory. |
